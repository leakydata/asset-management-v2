...
Private Sub BatchLookupCore(ByVal byDcn As Boolean)
    ...
    Dim ws As Worksheet: Set ws = MakeOutputSheet(rng.Worksheet.Parent, sheetBase)
    Dim grid() As Variant
...
' Output sheet
'==============================================================================
Private Function MakeOutputSheet(ByVal wb As Workbook, ByVal base As String) As Worksheet
